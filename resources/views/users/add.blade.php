                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('telepon') is-invalid @enderror"
                                                value="{{ old('telepon') }}" name="telepon" placeholder="Nomor Telepon">
                                            @error('telepon')
                                                <label class="mt-1" style="color: red">{{ $message }}</label>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('kecamatan') is-invalid @enderror"
                                                value="{{ old('kecamatan') }}" name="kecamatan" placeholder="Kecamatan">
                                            @error('kecamatan')
                                                <label class="mt-1" style="color: red">{{ $message }}</label>
                                            @enderror
                                        </div>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <a href="{{ url('/user') }}"><button type="button" class="btn btn-success">Ya</button></a>
