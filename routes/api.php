...
Route::group(['middleware' => 'auth:api'], function(){
    ...
    Route::get('listPenyakit', 'API\PenyakitController@listPenyakit');
    ...
    Route::get('rekomendasi/{id}', 'API\RekomendasiController@index');
    Route::get('detailPupuk/{id}', 'API\RekomendasiController@show');
